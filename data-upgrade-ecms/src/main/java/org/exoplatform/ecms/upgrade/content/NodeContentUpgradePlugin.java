package org.exoplatform.ecms.upgrade.content;
...
public class NodeContentUpgradePlugin extends UpgradeProductPlugin {

    private static final Log LOG = ExoLogger.getLogger(NodeContentUpgradePlugin.class);
    ...
    public NodeContentUpgradePlugin(SettingService settingService, 
    ...
    public void processUpgrade(String s, String s1) {
        ...
        LOG.info("Start upgrade of node");
        try {
            sessionProvider = SessionProvider.createSystemProvider();
            Session session = sessionProvider.getSession(WORKSPACE_COLLABORATION,
            ...
            throw new RuntimeException("An error occurred while node upgrade", e);
        } finally {

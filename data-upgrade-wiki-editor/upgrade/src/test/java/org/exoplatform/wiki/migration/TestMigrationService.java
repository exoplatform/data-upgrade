...
public class TestMigrationService extends BaseTest {
  ...
  public void setUp() throws Exception {
    ...
    migrationService = getContainer().getComponentInstanceOfType(PageContentMigrationServiceImpl.class);
  ...
  private void setupDefaultWikiContext() throws ComponentLookupException, ComponentRepositoryException {
    Execution ec = getContainer().getComponentInstanceOfType(RenderingService.class).getExecution();
